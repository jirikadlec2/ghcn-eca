...
<body>
    ...
    <div id="content">
      ...
      <div class="heading1">  <asp:Label CssClass="heading1" ID="PageTitle" runat="server" Text="Web Service"></asp:Label>
       ...
       <div class="intro">
            ...
            to provide access to data from the <a href="http://grafy.plaveniny.cz/en/snow"
                target="_blank"><span style="color: #0000ff">GHCN daily precipitation sites</span></a><br />
            in Idaho to provide information about precipitation. <strong>
                <br />
            </strong>
   ...
   Text=" <%$  AppSettings:serviceDescriptionPage %>"></asp:HyperLink>
        ...
        GetSiteInfo&nbsp; Series From OD:<asp:Label ID="Label11" runat="server" Text="<%$ AppSettings:UseODForValues %>"
            Width="73px"></asp:Label><br />
        GetValues from OD:<asp:Label ID="Label12" runat="server"
            Width="393px" Height="16px"></asp:Label><br />
        <br />
